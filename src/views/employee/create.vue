  ...
  <div>
    ...
    <n-form ref="formRef" :model="model" :rules="rules" label-placement="left" label-width="auto"
      ...
      <!-- <n-form-item label="职员技能" path="multipleSelectValue">
        <n-select v-model:value="model.multipleSelectValue" placeholder="Select" :options="generalSkills" multiple />
      </n-form-item> -->
      ...
      <n-form-item label="工作技能" path="multipleSelectValue">
        <n-transfer v-model:value="model.multipleSelectValue" :options="generalSkills" />
      </n-form-item>
